  ...
  return (
    <form ref={formRef} onSubmit={handleSubmit} noValidate>
      ...
      <div className={sectionClass}>
        ...
        <div className="mb-4">
          <label className={labelClass}>Company Name <span className="text-brand-pink">*</span></label>
          <input type="text" name="company_name" required minLength={2} className={inputClass} />
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
          <div>
            <label className={labelClass}>Contact Name <span className="text-brand-pink">*</span></label>
            <input type="text" name="contact_name" required minLength={2} className={inputClass} />
          </div>
          <div>
            <label className={labelClass}>Contact Email <span className="text-brand-pink">*</span></label>
      ...
      <div className={sectionClass}>
        ...
        <div className="mb-4">
          <label className={labelClass}>How would you like to sponsor? <span className="text-brand-pink">*</span></label>
          <div className="space-y-3 mt-2">
            {SPONSORSHIP_TYPES.map((type) => (
              <label key={type.value} className="flex items-start gap-3 p-3 rounded-lg border border-gray-200 dark:border-white/10 cursor-pointer hover:border-brand-pink/50 transition-colors">
                <input
                  type="radio"
      ...
      <div className={sectionClass}>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
          Select the chapter(s) you'd like to sponsor. <span className="text-brand-pink">*</span>
        </p>
      ...
      <div className={sectionClass}>
        <label className="flex items-start gap-2 text-sm text-navy dark:text-gray-300 cursor-pointer">
          ...
          />
          <span>
            I consent to my data being stored and shared with Cloud Native Nordics organisers for the purpose of coordinating sponsorship. <span className="text-brand-pink">*</span>
          </span>
        </label>
      </div>
