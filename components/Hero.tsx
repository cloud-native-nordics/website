  ...
  return (
    <section className="relative overflow-hidden bg-navy-deep pt-20 pb-28 sm:pt-28 sm:pb-36">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/3 left-1/4 w-[600px] h-[600px] rounded-full bg-brand-pink/20 blur-[100px] animate-pulse-glow [animation-delay:0.5s]" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="relative inline-block mb-10 animate-float">
          ...
          <div className="absolute inset-0 -m-10 rounded-full bg-brand-gold/25 blur-[50px] animate-pulse-glow" />
