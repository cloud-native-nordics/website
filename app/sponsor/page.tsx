    ...
    <>
      <section className="relative bg-navy-deep py-16 sm:py-20">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-1/2 -right-1/4 w-[600px] h-[600px] rounded-full bg-brand-gold/15 blur-[100px]" />
          <div className="absolute -bottom-1/3 -left-1/4 w-[500px] h-[500px] rounded-full bg-brand-pink/15 blur-[100px]" />
        </div>
